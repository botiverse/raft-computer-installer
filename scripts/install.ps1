...
$request = @{ protocol='raft-computer-installer/v1'; installerVersion='0.1.0'; computerVersion=$version; operation='upgrade'; operationId=$id; installDir=$dir } | ConvertTo-Json -Compress
$request | & $installer
